          ...
          >
            ...
            <ul className="lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              ...
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <Link href="/" className="lg:hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]">
                  Home
                </Link>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <Link href="/team" className="lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]">
                  Team
                </Link>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <Link href="/features" className="lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]">
                  Features
                </Link>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3">
                {/* Link to the blog page */}
                <Link href="/blog" className="lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]">
                  Blog
                </Link>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <Link href="/about" className="lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]">
                  About
                </Link>
              </li>
            </ul>
